...
const playerHealthBar = document
  .getElementById("player-healthbar")
  .getElementsByClassName("health-text")[0];
const enemyHealthBar = document
  .getElementById("enemy-healthbar")
  .getElementsByClassName("health-text")[0];
...
function startNewGame() {
  ...
  isGameActive = true;
  enemySprite.innerHTML = `<p></p>`;
  playerSprite.innerHTML = `<p></p>`;
}
...
function playRound(playerSelection) {
  ...
  enemySprite.innerHTML = `<p>${computerSelection}</p>`;
  playerSprite.innerHTML = `<p>${playerSelection}</p>`;
